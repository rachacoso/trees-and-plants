...
trees = [
  ...
  ["Liriodendron","tulipifera","Tulip tree","Deciduous. 70’ x 35’. Very tall tree with distinctive large four-lobed leaves. Greenish-yellow flowers in spring. Fissured, gray-brown bark. ","beautiful tree but gets HUGE……give it LOTS of space.   But, I like this tree, one of the few big big trees we have. ",75,nil,35,nil,false  ],
  ["Liriodendron","tulipifera","Tulip tree","Deciduous. 70’ x 35’. Very tall tree with distinctive large four-lobed leaves. Greenish-yellow flowers in spring. Fissured, gray-brown bark. ","",70,nil,35,nil,false  ],
